"""Helpers for loading IX Agency .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    already knows all valid IX Agency env-var names and can split
...
def load_hermes_dotenv(
    *,
    ...
    """Load IX Agency environment files with user config taking precedence.
...
def _apply_external_secret_sources(home_path: Path) -> None:
    ...
    to locate bootstrap tokens) but BEFORE the rest of IX Agency reads
