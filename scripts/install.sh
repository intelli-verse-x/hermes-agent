...
setup_venv() {
    ...
    # Quote UV_CMD — QuizVerse HERMES_HOME lives under "Application Support"
    # (space in path); unquoted expansion breaks at `/Library/Application`.
...
PY
    ...
    install_tier() {
        ...
        # Quote UV_CMD for paths with spaces (macOS Application Support).
