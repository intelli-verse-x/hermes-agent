...
AUTHOR_MAP = {
    "devashish.badlani@yahoo.com": "anideebee7",  # PRs #6/#7 (Intelliverse dual-brand desktop and QuizVerse MCP)
    "intelli-verse-x-health@anideebee.com": "anideebee7",  # machine author for employee desktop releases
