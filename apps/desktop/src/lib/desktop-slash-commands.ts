...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: `Switch the active ${BRAND_NAME} profile`, surface: action('profile') },
  ...
  { name: '/version', description: `Show ${BRAND_NAME} Agent version`, surface: exec() },
