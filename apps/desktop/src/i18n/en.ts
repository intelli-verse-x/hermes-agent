...
export const en: Translations = {
  ...
  boot: {
    ready: '{brandName} is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading {brandName} settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingDesktop: 'Starting {brandName}…'
    },
    errors: {
      backgroundExited: '{brandName} background process exited.',
      backgroundExitedDuringStartup: '{brandName} background process exited during startup.',
    ...
    failure: {
      title: "{brandName} couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your {brandName} backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateBrand: 'Update {brandName}',
    ...
    errors: {
      ...
      methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting {brandName}.',
    ...
    native: {
      ...
      inputBody: '{brandName} is waiting for your response.',
      turnDoneTitle: '{brandName} finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to {brandName} defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones {brandName} writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while {brandName} is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: '{brandName} asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while {brandName} was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let {brandName} follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what {brandName} is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen {brandName}, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        '{brandName} checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading {brandName} configuration...',
    ...
    gateway: {
      ...
      intro:
        '{brandName} starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running {brandName} backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private {brandName} backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote {brandName} backend.',
      ...
      restartingMessage: '{brandName} will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · {brandName} ${version}` : ''}`,
      ...
      sshDesc:
        '{brandName} is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: '{brandName} path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — {brandName} found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — {brandName} runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        '{brandName} is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the {brandName} path.',
      sshErrPlatform:
        'Unsupported remote platform. {brandName} SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update {brandName} on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. {brandName} runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point {brandName} at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As {brandName} builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart {brandName} to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update {brandName} to generate pets.',
      backgroundHint: 'You can close this — {brandName} will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure {brandName} desktop' },
    ...
    hermesActiveSessions: (version, count) => `{brandName} ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent {brandName} environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. {brandName} will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the {brandName} backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from {brandName}. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting {brandName}...',
    placeholderReconnecting: 'Reconnecting to {brandName}…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give {brandName} a task',
      "What's on your mind?",
    ...
    attachUrlDesc: '{brandName} will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask {brandName} to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating {brandName}…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting {brandName}…',
    ...
    unsupportedMessage: 'This version of {brandName} can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of {brandName} is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected {brandName} backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed {brandName} from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: '{brandName} will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the {brandName} desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The {brandName} updater takes over in its own window and reopens {brandName} automatically when it’s done. Please don’t reopen {brandName} yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. {brandName} reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then {brandName} reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: '{brandName} needs a one-time install',
    ...
    settingUpTitle: 'Setting up {brandName} Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another {brandName} CLI or desktop instance is running. Stop any running {brandName} instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The {brandName} installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with {brandName} Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: '{brandName} is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting {brandName}…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run {brandName}',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point {brandName} at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — {brandName} connects automatically',
    ...
    authorizeThere: 'Authorize {brandName} there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize {brandName} there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `{brandName} v${version}`,
      ...
      gatewayTitle: '{brandName} inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. {brandName} will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: '{brandName} is restarting...',
      askRestart: 'Ask {brandName} to restart the server',
      lookingRestart: taskId => `{brandName} is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: '{brandName} is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `{brandName} finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: '{brandName} could not restart the server.',
      stillWorking:
        '{brandName} is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: '{brandName} is loading a response',
    ...
    approval: {
      gatewayDisconnected: '{brandName} gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: '{brandName} needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: '{brandName} needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart {brandName} to use Save Image.',
    restartToSaveImages: 'Restart {brandName} to save images',
