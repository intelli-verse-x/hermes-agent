 ...
 */
export function foundrlySoulMd(opts?: { webUrl?: string; adminPortalUrl?: string; adminChatUrl?: string }): string {
  ...
  const adminChatUrl = opts?.adminChatUrl?.trim() || 'https://admin.intelli-verse-x.ai/admin/portal/chat'
